...
const UpdateTrain: React.FC = () => {
    ...
    const getLanguages = async () => {
        ...
        trainStore.languageWiseTrainName = trainStore.trainName.find((nameObj) => nameObj.languageId === trainStore.languageId)?.trainName || '';
    ...
    const onUpdate = async (event: any) => {
        ...
        if (trainStore?.isValidCreateTrainForm()) {
            isValidForm = true;
            await TrainHelper(navigate).UpdateTrain();
            ...
            <div className="row mb-2">
                <div className="col-4">
                    <div className="col" style={{ fontWeight: '600', fontSize: '18px' }}>
                        <span style={{ color: '#000000' }}>Update Train:</span>
                    </div>
                </div>
            </div>
            <div className="row">
...
export default observer(UpdateTrain);
