...
const UpdateGearType: React.FC = () => {
    ...
    const onUpdate = async (event: any) => {
        ...
        if (gearTypeStore?.isValidCreateGearTypeForm()) {
            isValidForm = true;
            await GearTypeHelper(navigate).UpdateGearType();
            ...
            <div className="row mb-2">
                <div className="col-4">
                    <div className="col" style={{ fontWeight: '600', fontSize: '18px' }}>
                        <span style={{ color: '#000000' }}>Update Gear Type</span>
                    </div>
                </div>
            </div>
            <div className="row">
...
export default observer(UpdateGearType);
