...
const UpdateGear: React.FC = () => {
    ...
    const onUpdate = async (event: any) => {
        ...
        if (gearStore?.isValidCreateGearForm()) {
            isValidForm = true;
            await GearHelper(navigate).UpdateGear();
            ...
            <div className="row mb-2">
                <div className="col-4">
                    <div className="col" style={{ fontWeight: '600', fontSize: '18px' }}>
                        <span style={{ color: '#000000' }}>Update Gear</span>
                    </div>
                </div>
            </div>
            <div className="row">
            ...
            <div className="row">
                <div className="col-4">
                    <FormGroup isRequired label='Select Station' labelSpacing='mb-1'
                        ...
                        <Select placeholder='Select Station' className="custom-input" defaultValue={gearStore?.stationId}
                ...
                <div className="col-4">
                    <FormGroup isRequired label='Select Gear Type' labelSpacing='mb-1'
                        ...
                        <Select placeholder='Select Geat Type' className="custom-input" defaultValue={gearStore?.gearTypeId}
...
export default observer(UpdateGear);
