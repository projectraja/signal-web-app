...
const UpdateAdmin: React.FC = () => {
    ...
    const onUpdate = async (event: any) => {
        event.preventDefault();
        if (authStore?.isValidAdminUpdateForm()) {
            isValidForm = true;
            await AuthHelper().UpdateAdmin(navigate);
            ...
            <div className="row mb-2">
                <div className="col-4">
                    <div className="col" style={{ fontWeight: '600', fontSize: '18px' }}>
                        <span style={{ color: '#000000' }}>Update Admin:</span>
                    </div>
                </div>
            </div>
            <div className="row">
            ...
            <div className="row">
                <div className="col-4">
                    <FormGroup isRequired label='Station Code' labelSpacing='mb-1' error={authStore?.formRegistrationErrors?.adminStationId}>
                        <Select placeholder="Select Station" className="custom-input" style={{ width: '100%' }} defaultValue={authStore?.adminStationId}
...
export default observer(UpdateAdmin);
